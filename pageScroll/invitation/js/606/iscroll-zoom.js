...
// INSERT POINT: OPTIONS 
		...
		preventDefault: true,
		preventDefaultException: { tagName: /^(INPUT|TEXTAREA|BUTTON|SELECT|P|A|DIV|IMG)$/ },
...
// INSERT POINT: _translate
	...
	_zoomStart: function (e) {
		...
		this.originX = Math.abs(e.touches[0].pageX + e.touches[1].pageX) / 2 + 0 - this.x;
		this.originY = Math.abs((e.touches[0].pageY - $(window).scrollTop()) + (e.touches[1].pageY - $(window).scrollTop())) / 2 + 0 - this.y;
	...
	zoom: function (scale, x, y, time) {
		...
		y = y === undefined ? this.wrapperHeight / 2 : (y - $(window).scrollTop());
