...
if (!navigator.userAgent.match(/UCBrowser.*/i) && !navigator.userAgent.match(/Mac OS.*/i) && !navigator.userAgent.match(/Chrome.*/i) && !navigator.userAgent.match(/Android\s*4\.\d.*/i)) {
    ...
    (function() {
        ...
        u.i.gc = function(a, c) {
            ...
            a = u.i.copy(a);
            for (d in c)
                w.call(c, d) && (e = a[d], g = c[d], a[d] = u.i.oc(e) && u.i.oc(g) ? u.i.gc(e, g) : c[d]);
            return a
        };
        u.i.copy = function(a) {
            return u.i.B({}, a)
        ...
        var ba = u, z;
        var A = u.G.match(/Android (\d+)(?:\.(\d+))?(?:\.(\d+))*/i), B, C;
        ...
        t = u.o.prototype;
        t.e = function(a, c) {
            c = u.i.B({className: this.Q(),innerHTML: '<div class="vjs-control-content"><span class="vjs-control-text">' + (this.oa || "Need Text") + "</span></div>",dd: "button","aria-live": "polite",tabIndex: 0}, c);
        ...
        t.e = function(a, c) {
            ...
            c = u.i.B({dd: "slider","aria-valuenow": 0,"aria-valuemin": 0,"aria-valuemax": 100,tabIndex: 0}, c);
            return u.c.prototype.e.call(this, a, c)
        };
        t.Oa = function(a) {
            a.preventDefault();
        ...
        u.la.prototype.e = function() {
            ...
            this.qa = u.e(a, {className: "vjs-menu-content"});
            a = u.c.prototype.e.call(this, "div", {append: this.qa,className: "vjs-menu"});
        ...
        t.Ja = function() {
            ...
            this.options().title && a.r().appendChild(u.e("li", {className: "vjs-menu-title",innerHTML: u.Z(this.A),md: -1}));
            if (this.J = this.sb())
        ...
        t.e = function() {
            ...
            if (c.hasChildNodes()) {
                ...
                e = d.length;
                for (k = []; e--; )
                    g = d[e], j = g.nodeName.toLowerCase(), ("source" === j || "track" === j) && k.push(g);
            ...
            a.h.P(function() {
                ...
                if (!this.j.Mb) {
                    ...
                    a.Qa = setInterval(u.bind(a, function() {
                        this.s.mb < this.buffered().end(0) ? this.k("progress") : 1 == this.Ha() && 
                        (clearInterval(this.Qa), this.k("progress"))
                    }), 500);
        ...
        t.volume = function(a) {
            if (a !== b)
                return a = Math.max(0, Math.min(1, parseFloat(a))), this.s.volume = a, K(this, "setVolume", a), u.gd(a), this;
        ...
        t.pb = function() {
            ...
            if (a)
                ...
                this.h.Sa() ? K(this, "exitFullScreen") : (L(this), this.k("fullscreenchange"));
            return this
        };
        t.ic = function(a) {
        ...
        t.src = function(a) {
            if (a instanceof Array) {
                ...
                c ? (a = c.source, c = c.h, c == this.ya ? this.src(a) : H(this, c, a)) : this.b.appendChild(u.e("p", {innerHTML: 'Sorry, no compatible source and playback technology were found for this video. Try using another browser like <a href="http://bit.ly/ccMUEC">Chrome</a> or download the latest <a href="http://adobe.ly/mwfN1">Adobe Flash Player</a>.'}))
            } else
                a instanceof 
        ...
        u.da = u.c.extend({g: function(a, c) {
                ...
                a.R("play", u.bind(this, function() {
                    ...
                    this.a.d("touchend", u.bind(this, function(c) {
                        var e;
                        a && (e = this.r().className.search("fade-in"), -1 !== 
                        e ? this.ta() : this.$());
                        a = l;
        ...
        u.da.prototype.f = {Ad: "play",children: {playToggle: {},currentTimeDisplay: {},timeDivider: {},durationDisplay: {},remainingTimeDisplay: {},progressControl: {},fullscreenToggle: {},volumeControl: {},muteToggle: {}}};
        ...
        u.Yb = u.M.extend({g: function(a, c) {
                u.M.call(this, a, c);
        ...
        u.jb = u.c.extend({g: function(a, c) {
                u.c.call(this, a, c);
        ...
        u.ib = u.M.extend({g: function(a, c) {
                u.M.call(this, a, c);
        ...
        u.Fa = u.ea.extend({g: function(a, c) {
                u.ea.call(this, a, c);
                a.d("volumechange", u.bind(this, this.update));
                a.h && (a.h.j && a.h.j.U === l) && this.p("vjs-hidden");
                a.d("loadstart", u.bind(this, function() {
        ...
        u.Fa.prototype.Ja = function() {
            var a = new u.la(this.a, {Kc: "div"}), c = new u.ib(this.a, u.i.B({pd: f}, this.f.Dd));
            a.Y(c);
            return a
        };
        u.Fa.prototype.n = function() {
        ...
        u.m = u.q.extend({g: function(a, c, d) {
                ...
                this.d("click", this.n);
                for (a = u.m.$a.length - 1; 0 <= a; a--)
                    u.d(this.b, u.m.$a[a], u.bind(this.a, this.Pc));
                this.Ta()
            }});
        t = u.m.prototype;
        t.D = function() {
        ...
        t.e = function() {
            var a = this.a, c = a.F;
            if (!c || this.j.Uc === l)
                c ? (c.player = h, a.F = h, a.r().removeChild(c), c = c.cloneNode(l)) : c = u.e("video", {id: a.id() + "_html5_api",className: "vjs-tech"}), c.player = a, u.zb(c, a.r());
        ...
        u.l = u.q.extend({g: function(a, c, d) {
                ...
                a = a.f;
                var k = u.i.B({readyFunction: "videojs.Flash.onReady",eventProxyFunction: "videojs.Flash.onEvent",errorEventProxyFunction: "videojs.Flash.onError",autoplay: a.autoplay,preload: a.Pa,loop: a.loop,muted: a.muted}, c.flashVars), q = u.i.B({wmode: "opaque",bgcolor: "#000000"}, c.params), n = u.i.B({id: j,name: j,"class": "vjs-tech"}, c.attributes);
        ...
        function V(a, c, d) {
            for (var e = a.za, g = 0, j = e.length, k, q; g < j; g++)
                k = e[g], k.id() === c ? (k.show(), q = k) : d && (k.K() == d && 0 < k.mode()) && k.disable();
            (c = q ? q.K() : d ? d : l) && a.k(c + "trackchange")
        }
        u.V = u.c.extend({g: function(a, c) {
                u.c.call(this, a, c);
        ...
        t.update = function() {
            if (0 < this.ha.length) {
                ...
                if (this.Lb === b || a < this.Lb || this.La <= a) {
                    var c = this.ha, d = this.a.duration(), e = 0, g = l, j = [], k, q, n, s;
                    a >= this.La || this.La === b ? s = this.wb !== b ? this.wb : 0 : (g = f, s = this.Db !== b ? this.Db : c.length - 1);
                    for (; ; ) {
                        n = c[s];
                        if (n.sa <= a)
                            e = Math.max(e, n.sa), n.Ga && (n.Ga = l);
                        else if (a < n.startTime) {
                            if (d = Math.min(d, n.startTime), n.Ga && (n.Ga = l), !g)
                                break
                        } else
                            g ? (j.splice(0, 0, n), q === b && (q = s), k = s) : (j.push(n), k === b && (k = s), q = s), d = Math.min(d, n.sa), e = Math.max(e, n.startTime), 
                            n.Ga = f;
                        if (g)
                            if (0 === s)
                                break;
        ...
        u.cb = u.X.extend({g: function(a, c) {
                c.track = {K: function() {
                        return c.kind
                    },bd: a,label: function() {
                        return c.kind + " off"
        ...
        u.W = u.ea.extend({g: function(a, c) {
                u.ea.call(this, a, c);
        ...
        u.W.prototype.sb = function() {
            ...
            for (var d = 0; d < U(this.a).length; d++)
                c = U(this.a)[d], c.K() === this.A && a.push(new u.X(this.a, {track: c}));
            return a
        };
        ...
        u.Ea = u.W.extend({g: function(a, c, d) {
                u.W.call(this, a, c, d);
        ...
        u.Sb = u.W.extend({g: function(a, c, d) {
                u.W.call(this, a, c, d);
        ...
        t.Ja = function() {
            for (var a = U(this.a), c = 0, d = a.length, e, g, j = this.J = []; c < d; c++)
                if (e = a[c], e.K() == this.A && e.ub()) {
                    if (2 > e.readyState()) {
                        this.wd = e;
            ...
            a.b.appendChild(u.e("li", {className: "vjs-menu-title",innerHTML: u.Z(this.A),md: -1}));
            if (g) {
                e = g.ha;
                for (var k, c = 0, d = e.length; c < d; c++)
                    k = e[c], k = new u.Xa(this.a, {track: g,cue: k}), j.push(k), a.Y(k)
            }
            0 < this.J.length && this.show();
            return a
        };
        u.Xa = u.L.extend({g: function(a, c) {
